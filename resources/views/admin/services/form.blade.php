    ...
    <div class="card border border-primary">
        ...
        <div class="card-body">
            ...
            <form method="POST"
                ...
                <div class="mb-3">
                    <input type="text" name="title_pt" class="form-control" placeholder="Título do serviço em português"
                        value="{{ old('title_pt', $service->title_pt ?? '') }}">
                </div>
                ...
                <div class="mb-3">
                    <textarea class="form-control summernote" id="description_pt" name="description_pt" rows="6"
                        placeholder="Descreva o serviço em português...">{{ old('description_pt', $service->description_pt ?? '') }}</textarea>
                </div>
