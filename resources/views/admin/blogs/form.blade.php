            ...
            <form method="POST"
                ...
                <div class="mb-3">
                    <input type="text" name="title_pt" class="form-control" placeholder="Criar um título em português"
                        value="{{ old('title_pt', $blog->title_pt ?? '') }}">
                    <small class="text-muted">
                ...
                <div class="mb-3">
                    <textarea class="form-control summernote" id="content_pt" name="content_pt" rows="6"
                        placeholder="Escreva o conteúdo do blog em português...">{{ old('content_pt', $blog->content_pt ?? '') }}</textarea>
                    <small class="text-muted">
                        Conteúdo do blog em português.
                    </small>
                </div>
