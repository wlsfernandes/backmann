          ...
          @foreach ($projects as $project)
            ...
            <tr>
              ...
              <td class="align-middle text-center">
                <a href="{{ route('admin.projects.images.index', $project) }}" class="btn btn-outline-primary btn-sm"
              ...
              <td>
                ...
                <strong>
                  <a href="{{ route('admin.projects.display', $project->slug) }}" target="_blank" class="text-decoration-none">
                    {{ $project->title }}
                  </a>
                </strong>
                ...
                <div class="small text-muted mt-1">
                  ...
                  <a href="{{ route('admin.projects.display', $project->slug) }}" target="_blank" class="text-decoration-none">
                    {{ route('admin.projects.display', $project->slug) }}
                  </a>
                </div>
              </td>
