    ...
    <div class="card border border-primary">
        ...
        <div class="card-body">
            ...
            <form method="POST"
                ...
                {{-- Title PT --}}
                <div class="mb-3">
                    <label class="form-label">Title (Portuguese)</label>
                    <input type="text" name="title_pt" class="form-control"
                        value="{{ old('title_pt', $project->title_pt ?? '') }}" required>
                </div>
                <hr>
                ...
                {{-- Description PT --}}
                <div class="mb-3">
                    <label class="form-label">Description (Portuguese)</label>
                    <textarea class="form-control summernote" id="description_pt" name="description_pt" rows="4"
                        placeholder="Descrição do projeto em português...">{{ old('description_pt', $project->description_pt ?? '') }}</textarea>
                </div>
