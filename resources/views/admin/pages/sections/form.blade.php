...
@section('content')
    <div class="card border border-primary">
        ...
        <div class="card-body">
            ...
            <form method="POST"
                action="{{ isset($section) ? route('admin.pages.sections.update', [$page, $section]) : route('admin.pages.sections.store', $page) }}"
                ...
                <div class="row mb-4">
                    ...
                    <h6 class="mb-3">Portuguese Content</h6>

                    <div class="mb-3">
                        <label class="form-label">Title (PT)</label>
                        <input type="text" name="title_pt" class="form-control"
                            value="{{ old('title_pt', $section->title_pt ?? '') }}">
                    </div>

                    <textarea name="content_pt" id="content_pt" class="form-control section-editor" rows="6"
                        placeholder="Escreva o conteúdo da seção em português...">{{ old('content_pt', $section->content_pt ?? '') }}</textarea>

                    <hr>
                    {{-- Actions --}}
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('admin.pages.sections.index', $page) }}" class="btn btn-light">
