...
@section('content')
    <div class="card border border-primary">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.pages.sections.create', $page) }}" class="btn btn-success">
                    ...
                    @forelse ($sections as $section)
                        <tr>
                            <td class="align-middle text-center">
                                ...
                                <a href="{{ route('admin.pages.sections.edit', [$page, $section]) }}" class="text-primary small"
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.pages.sections.destroy', [$page, $section]) }}" method="POST"
