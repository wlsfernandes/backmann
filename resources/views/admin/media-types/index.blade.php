...
@section('content')
  <div class="card border border-primary">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <a href="{{ route('admin.media-types.create') }}" class="btn btn-success">
        ...
        <tbody>
          @foreach ($mediaTypes as $mediaType)
            <tr>
              ...
              {{-- Actions --}}
              <td>
                <a href="{{ route('admin.media-types.edit', $mediaType) }}" class="btn btn-sm btn-warning">
                  <i class="uil uil-pen"></i>
                </a>

                <form action="{{ route('admin.media-types.destroy', $mediaType) }}" method="POST" class="d-inline"
