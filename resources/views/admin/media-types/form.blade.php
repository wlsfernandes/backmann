...
@section('content')
  <div class="card border border-primary">
    ...
    <div class="card-body">
      ...
      <form method="POST"
        action="{{ isset($mediaType) ? route('admin.media-types.update', $mediaType) : route('admin.media-types.store') }}">
    ...
    {{ old('description_es', $mediaType->description_es ?? '') }}
        ...
        <div class="d-flex justify-content-between mt-4">
          <a href="{{ route('admin.media-types.index') }}" class="btn btn-secondary">
