            ...
            <form method="POST"
                ...
                <div class="mb-3">
                    <input type="text" name="title_en" class="form-control"
                        placeholder="Create a banner title in English"
                ...
                <div class="mb-3">
                    <input type="text" name="title_pt" class="form-control" placeholder="Criar um título em português"
                        value="{{ old('title_pt', $banner->title_pt ?? '') }}">
                    <small class="text-muted">
                        Optional Portuguese version of the title.
                    </small>
                </div>
                <hr>
                ...
                <div class="mb-3">
                    <input type="text" name="subtitle_es" class="form-control"
                        placeholder="Subtítulo opcional en español"
                        value="{{ old('subtitle_es', $banner->subtitle_es ?? '') }}">
                </div>
                <div class="mb-3">
                    <input type="text" name="subtitle_pt" class="form-control"
                        placeholder="Subtítulo opcional em português"
                        value="{{ old('subtitle_pt', $banner->subtitle_pt ?? '') }}">
                    <small class="text-muted">
                        Optional Portuguese version of the subtitle.
                    </small>
                </div>
                <hr>
