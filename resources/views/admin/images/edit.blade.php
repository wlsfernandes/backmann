        ...
        <div class="mb-3">
          <label class="form-label fw-semibold">
            ...
            <small class="text-muted d-block mt-1">
                <strong>Logo</strong> keeps the full image and scales for headers.<br>
                <strong>Crop</strong> types keep layout perfect (banner/card) but may cut edges.<br>
