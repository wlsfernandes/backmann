...
@section('content')
    <div class="card border border-danger">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.developer-settings.update') }}">
                @csrf
                @method('PUT')
    ...
    <button type="button"
        ...
        <i class="fab fa-stripe"></i> Test Stripe Connection
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.developer-settings.index') }}"
...
function testStripeConnection() {
    fetch("{{ route('admin.developer-settings.test-stripe') }}", {
        method: "POST",
        headers: {
