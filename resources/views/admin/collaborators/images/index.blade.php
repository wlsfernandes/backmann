...
@section('content')
    <div class="card border border-primary">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.collaborators.edit', $collaborator) }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card-body">
            ...
            {{-- Upload --}}
            <form method="POST" action="{{ route('admin.collaborators.images.store', $collaborator) }}"
                        ...
                        <div class="col-md-3 col-sm-4 col-6">
                            <div class="card h-100">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    {{-- Link Form --}}
                                    <form method="POST"
                                        action="{{ route('admin.collaborators.images.updateLink', [$collaborator, $image]) }}"
                                        class="mb-2">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    {{-- Delete --}}
                                    <form action="{{ route('admin.collaborators.images.destroy', [$collaborator, $image]) }}"
