          ...
          @foreach ($collaborators as $collaborator)
            ...
            <tr>
              ...
              <td class="align-middle text-center">
                <a href="{{ route('admin.collaborators.images.index', $collaborator) }}" class="btn btn-outline-primary btn-sm"
              ...
              <td>
                ...
                <strong>
                  <a href="{{ route('admin.collaborators.display', $collaborator->slug) }}" target="_blank" class="text-decoration-none">
                    {{ $collaborator->title }}
                  </a>
                </strong>
                ...
                <div class="small text-muted mt-1">
                  ...
                  <a href="{{ route('admin.collaborators.display', $collaborator->slug) }}" target="_blank" class="text-decoration-none">
                    {{ route('admin.collaborators.display', $collaborator->slug) }}
                  </a>
                </div>
              </td>
              ...
              {{-- Actions --}}
              <td>
                <a href="{{ route('admin.collaborators.edit', $collaborator) }}" class="btn btn-sm btn-warning">
                  <i class="uil-pen"></i>
                </a>

                <form action="{{ route('admin.collaborators.destroy', $collaborator) }}" method="POST" class="d-inline"
