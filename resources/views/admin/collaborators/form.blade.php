...
@section('content')
    <div class="card border border-primary">
        ...
        <div class="card-body">
            ...
            <form method="POST"
                action="{{ isset($collaborator) ? route('admin.collaborators.update', $collaborator) : route('admin.collaborators.store') }}">
                @csrf
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.collaborators.index') }}" class="btn btn-secondary">
