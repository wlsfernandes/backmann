...
@section('content')
    <div class="card border border-primary">
        ...
        <div class="card-body">
            ...
            <form method="POST"
                action="{{ isset($about) ? route('admin.abouts.update', $about) : route('admin.abouts.store') }}">
                @csrf
                @isset($about)
                    @method('PUT')
                @endisset
                ...
                <div class="mb-3">
                    <input type="text" name="title_pt" class="form-control" placeholder="Título em português"
                        value="{{ old('title_pt', $about->title_pt ?? '') }}">
                </div>
                ...
                <div class="mb-3">
                    <input type="text" name="subtitle_pt" class="form-control" placeholder="Subtítulo em português"
                        value="{{ old('subtitle_pt', $about->subtitle_pt ?? '') }}">
                </div>
                ...
                <div class="mb-3">
                    <textarea class="form-control summernote" id="content_pt" name="content_pt" rows="6"
                        placeholder="Escreva o conteúdo em português...">{{ old('content_pt', $about->content_pt ?? '') }}</textarea>
                </div>
