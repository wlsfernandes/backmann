...
@section('content')
  <div class="card border border-primary">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <a href="{{ route('admin.book-recommendations.create') }}" class="btn btn-success">
        ...
        <tbody>
          @foreach ($books as $book)
            <tr>
              ...
              {{-- Actions --}}
              <td>
                <a href="{{ route('admin.book-recommendations.edit', $book) }}" class="btn btn-sm btn-warning">
                  <i class="uil uil-pen"></i>
                </a>

                <form action="{{ route('admin.book-recommendations.destroy', $book) }}" method="POST" class="d-inline"
