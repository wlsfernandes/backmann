...
@section('content')
  <div class="card border border-primary">
    ...
    <div class="card-body">
      ...
      <form method="POST"
        action="{{ isset($book) ? route('admin.book-recommendations.update', $book) : route('admin.book-recommendations.store') }}">
        @csrf
        @if (isset($book))
          @method('PUT')
        @endif
        ...
        <div class="d-flex justify-content-between">
          <a href="{{ route('admin.book-recommendations.index') }}" class="btn btn-secondary">
